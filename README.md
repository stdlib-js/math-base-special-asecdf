...
```javascript
import asecdf from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-asecdf@v0.0.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-asecdf/actions/workflows/test.yml/badge.svg?branch=v0.0.3
[test-url]: https://github.com/stdlib-js/math-base-special-asecdf/actions/workflows/test.yml?query=branch:v0.0.3
